...
''' 
core_path = '/Users/noltesz/project_accelerator/accelerator-core'
if not os.path.exists(core_path):
    raise ImportError(f"The specified path '{core_path}' does not exist.")
else:
    import sys
...
class CDCAccelSource(AccelIngestComponent):
    ...
    def fetch_cdc_metadata(api_url: str = None, params: dict = None, rows: int = 1000) -> dict:
        ...
        #I download the cdc data at 04_17_2025 for the development
        json_file = "./tests/test_resources/cdc_dump_04_17_2025.json"
    ...
    @staticmethod
    def dump_cdc_meta (metadata: list, base_folder: str = "./tests/test_resources") -> str:
